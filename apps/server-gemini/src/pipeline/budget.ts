...
const TIERS: Record<Tier, Omit<InputBudget, "sourceCount" | "totalSourceChars">> = {
  ...
  small: {
    ...
    planetBodyWords:      { min: 340, max: 430 },
    conceptBodyWords:     { min: 215, max: 290 },
    solarSystemBodyWords: { min: 100, max: 135 },
    storyIntroWords:      { min: 215, max: 240 },
    sceneWords:           { min: 215, max: 240 },
    conclusionWords:      { min: 130, max: 145 },
  },
  medium: {
    tier: "medium",
    model: "pro",
