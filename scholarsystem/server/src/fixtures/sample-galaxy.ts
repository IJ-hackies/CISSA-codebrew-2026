...
const raw = {
  ...
  detail: {
    [`${CH}-rocky-planet-def`]: {
      ...
      derivatives: [
        { sourceRef: `${CH}-s-0002`, quote: "Rocky planets have solid surfaces made of silicate rock or metal." },
      ],
      ...
      mnemonics: [], emphasisMarkers: [],
      sourceQuotes: ["Rocky planets have solid surfaces made of silicate rock or metal."],
    ...
    [`${CH}-hydrogen-fusion`]: {
      ...
      derivatives: [
        { sourceRef: `${CH}-s-0006`, quote: "Main-sequence stars fuse hydrogen into helium via the proton-proton chain." },
      ],
      ...
      sourceQuotes: ["Main-sequence stars fuse hydrogen into helium via the proton-proton chain."],
      sourceRefs: [`${CH}-s-0006`], extractedAt: now - 6800,
    },
  },
